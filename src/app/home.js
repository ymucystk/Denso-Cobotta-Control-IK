...
export default function Home(props) {
  ...
  const joint_pos = {
    ...
    j2:{x:0,y:0.18,z:0},
    j3:{x:0,y:0.165,z:0},
    j4:{x:0.02,y:0.1766,z:-0.0122},
    j5:{x:0,y:0,z:0},
    j6:{x:0.0644,y:0,z:0},
    j7:{x:0,y:0,z:0.1},
  }

  const [target,set_target] = React.useState({x:0.25,y:0.25,z:0.25})
...
const Assets = ()=>{
  return (
    <a-assets>
      ...
      <a-asset-items id="j1" src="Cobotta_j0.gltf" ></a-asset-items>
      <a-asset-items id="j2" src="Cobotta_j1.gltf" ></a-asset-items>
      <a-asset-items id="j3" src="Cobotta_j2.gltf" ></a-asset-items>
      <a-asset-items id="j4" src="Cobotta_j3.gltf" ></a-asset-items>
      <a-asset-items id="j5" src="Cobotta_j4.gltf" ></a-asset-items>
      <a-asset-items id="j6" src="Cobotta_j5.gltf" ></a-asset-items>
...
const Model_Tool = (props)=>{
  ...
  const return_table = [
    <>
      <a-entity gltf-model="#j6_1" position="0.01 0 0.078"></a-entity>
      <a-entity gltf-model="#j6_2" position="-0.01 0 0.078"></a-entity>
